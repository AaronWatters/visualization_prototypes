...
var DATA_FILE = "./two_helices.json";
var json_data = null;
...
var setup = function(data) {
    ...
    var center = data.helix1.center;
    var radius = data.helix1.radius;
    ...
    */
    ...
    var add_helix = function (data, color, x_offset) {
        ...
        geometry.translate(x_offset, 0, 0);
    ...
    add_helix(data.helix1, 0xAAA9AD, -radius * 0.25);
    add_helix(data.helix2, 0xD4AF37, radius * 0.25);
