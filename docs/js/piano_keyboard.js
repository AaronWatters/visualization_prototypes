...
<<<<<<< HEAD
  class PianoKeyboard {
    constructor(element, options) {
      ...
      this.canvas.addClass('piano__wrapper');
      ...
      this.canvas.fit();
      this.control_wrapper_div = $('<div class="control__wrapper"></div>').appendTo(element);
      //this.control_wrapper_div.css({
      //height: "50px",
      ...
      //});
      this.file_drop_label = $('<label for="audiomidi">Upload a file</label>').appendTo(this.control_wrapper_div);
      this.file_drop_input = $('<input type="file" accept="audio/midi" name="audiomidi"/>').appendTo(
        this.control_wrapper_div
      );
      this.midi_button_div = $('<div class="midi-button__grid"></div>').appendTo(this.control_wrapper_div);
      this.play_button_div = $('<div/>').appendTo(this.element);
      this.play_midi_button = $('<button class="button-primary">Play midi</button>ß').appendTo(this.play_button_div);
      ...
      if (!(window.File && window.FileReader && window.FileList && window.Blob)) {
        this.control_wrapper_div.html("THIS BROWSER DOESN'T SUPPORT FILE PROCESSING.");
      } else {
      ...
      this.info = $('<div class="info-text info-bar">keyboard drawn</div>').appendTo(element);
    ...
    add_midi_url_button(url, title) {
      title = title || url;
      var that = this;
      var midi_button_div = this.midi_button_div;
      //control_wrapper_div.height(control_wrapper_div.height() + 20);
      var url_div = $('<div/>').appendTo(midi_button_div);
...
>>>>>>> 2ddcc7a7e52006d29dfd3e85be9a3d638b64f8cd
